...
public:
	...
	bool ReceiveImage_Find1stVideo(unsigned char *pixels, unsigned int &width, unsigned int &height, bool bInvert);
	bool ReceiveImage_FindLastVideo(unsigned char *pixels, unsigned int &width, unsigned int &height, bool bInvert);
	...
	bool ReceiveImage_Find1stVideo(unsigned int &width, unsigned int &height, FILE* fp_log = nullptr);
	bool ReceiveImage_FindLastVideo(unsigned int &width, unsigned int &height, FILE* fp_log = nullptr);
...
private:
	...
	bool bReceiverConnected = false; // sj : 初期化	// Is the receiver connected and receiving frames
