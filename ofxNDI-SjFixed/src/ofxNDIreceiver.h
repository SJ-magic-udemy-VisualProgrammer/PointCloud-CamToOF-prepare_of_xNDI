...
public:
	...
	bool ReceiveImage(ofTexture &texture, ReceiveType receivetype = ReceiveType::kFind1stVideo, FILE* fp_log = nullptr);
	
	
	// Receive an fbo
	// - fbo re-allocated for changed sender dimensions
	bool ReceiveImage(ofFbo &fbo, ReceiveType receivetype = ReceiveType::kFind1stVideo, FILE* fp_log = nullptr);

	// Receive an image
	// - image re-allocated for changed sender dimensions
	bool ReceiveImage(ofImage &image, ReceiveType receivetype = ReceiveType::kFind1stVideo, FILE* fp_log = nullptr);

	// Receive a pixel buffer
	// - buffer re-allocated for changed sender dimensions
	bool ReceiveImage(ofPixels &buffer, ReceiveType receivetype = ReceiveType::kFind1stVideo, FILE* fp_log = nullptr);
	...
	bool ReceiveImage(unsigned char *pixels, unsigned int &width, unsigned int &height, bool bInvert = false, ReceiveType receivetype = ReceiveType::kFind1stVideo, FILE* fp_log = nullptr);
